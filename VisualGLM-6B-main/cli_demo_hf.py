...
tokenizer = AutoTokenizer.from_pretrained("/home/dengxuan/VisualGLM-6B-main/visualglm-6b", trust_remote_code=True)
model = AutoModel.from_pretrained("/home/dengxuan/VisualGLM-6B-main/visualglm-6b", trust_remote_code=True).half().cuda()
model = model.eval()
